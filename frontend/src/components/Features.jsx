    ...
    return (
        ...
        >
            ...
            <div
                ...
                >
                    <div
                        className="rounded-8xl bg-orange flex flex-row rounded-2xl items-center justify-center p-[1.2rem]">
                ...
                >
                    <div
                        className="rounded-8xl bg-[#f85e9f] flex  rounded-2xl flex-row items-start justify-start p-[1.2rem]">
                        <div className="p-1 relative rounded-3xl bg-orange hidden"/>
                ...
                >
                    <div
                        className="rounded-8xl bg-yellow flex rounded-2xl flex-rowitems-start justify-start p-[1.2rem]">
                        <div className="p-1 relative rounded-3xl bg-orange hidden"/>
                        <img
