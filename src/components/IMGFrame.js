...
const IMGFrame = memo(() => {
  return (
    <div className="w-[80.88rem] flex flex-row flex-wrap items-start justify-start py-[0rem] px-[1.25rem] box-border max-w-full shrink-0 text-left text-[1.24rem] text-dimgray-200 font-poppins">
