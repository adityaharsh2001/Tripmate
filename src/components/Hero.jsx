            ...
            <AnimatePresence>
                ...
                >
                    <div className="flex flex-row items-center justify-between">
                        <div className="flex flex-col items-center md:items-start justify-between gap-[2rem]">
                            ...
                            <div className="relative text-[1.13rem] w-full leading-[160%] font-body text-grey-scale-black-50 inline-block">
                                <p className="m-0">
