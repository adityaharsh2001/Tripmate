...
const Homepage = () => {
    return (
        <div className={"text-secondary font-poppins"}>
            ...
            <Features/>
            <div
                className="w-full self-stretch relative md:px-20 p-10 mt-20 flex flex-col items-center justify-start pt-[0rem] px-[0rem] pb-[0.75rem] box-border gap-[0.06rem] max-w-full shrink-0 text-left text-[2.48rem] text-black font-poppins">
                <div
                    className="flex w-full flex-row items-start justify-start pt-[0rem] px-[1.25rem] pb-[4.56rem] box-border max-w-full shrink-0">
                    <div
                        ...
                        <div className="flex text-secondary flex-col items-start justify-start gap-[1rem] max-w-full shrink-0">
                        ...
                        <button
                            ...
                            <div
                                className="relative text-[1.24rem] font-semibold font-poppins text-royalblue-200 text-left">
                                View All Stories
                            </div>
                        </button>
                    </div>
            ...
            {/*<footer*/}
            {/*    className="w-full h-[22.5rem] flex flex-row items-center justify-between py-[0rem] px-[7.88rem] box-border gap-[1.25rem] text-left text-[1.44rem] text-grey-scale-black-50 font-poppins">*/}
            {/*    <div*/}
