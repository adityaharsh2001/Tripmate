            ...
            <div className="antialiased bg-gray-50 dark:bg-gray-900">
                ...
                <main className="p-4 md:ml-64 h-auto pt-20">
                    ...
                    <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Add A Category</h2>
                    ...
                    <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Add Top Packages</h2>
