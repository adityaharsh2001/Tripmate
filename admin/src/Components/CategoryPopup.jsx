...
const CategoryPopup = ({open, setOpen, categoryData = null}) => {
    ...
    const handleCreateCategory = async (e) => {
        try {
            ...
            if (categoryData) {
                await axios.put(`http://admintm.geekyadi.dev/api/v1/packages/categories/${id}`, {
                        name,
                        description,
                        image
                    }, {
                ...
                await axios.post('http://admintm.geekyadi.dev/api/v1/packages/categories', {
                        name,
                        description,
                        image
                    }, {
    ...
    const updateCategory = async () => {
        try {
            await axios.patch(`http://admintm.geekyadi.dev/api/v1/packages/categories/${categoryData.id}`, {
                name,
                description,
                image
            }, {
    ...
    const deleteCategory = async (e) => {
        try {
            e.preventDefault()
            await axios.delete(`http://admintm.geekyadi.dev/api/v1/packages/categories/${categoryData.id}`, {
                withCredentials: true,
                headers: {
                    Authorization: `Bearer ${JSON.parse(localStorage.getItem('token'))?.access.token}`,
                }
